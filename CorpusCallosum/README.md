...
### Main Pipeline: `fastsurfer-cc.py`
...
python3 run_pipeline.py --in_mri /path/to/input/mri.mgz --aseg /path/to/input/aseg.mgz --output_dir /path/to/output --verbose

# Using FastSurfer/FreeSurfer subject directory structure
python3 run_pipeline.py --subject_dir /path/to/freesurfer/subject --verbose
```
...
python3 run_pipeline.py --subject_dir /data/subjects/sub001 --verbose

# Custom shape analysis parameters
python3 run_pipeline.py --subject_dir /data/subjects/sub001 \
